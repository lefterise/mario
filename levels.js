var level1 = { 
    ...
    tileTint: 0,
    pipes: [       
        {entrance: {x:  50, y: 6, direction: 0}, exit: {x: 2, y: 2, direction: 1, level: "level1b", storeState: "level1"}},
...
level3 = { 
    ...
    tileTint: 0,
    pipes: [       
      {entrance: {x:  133, y: 7, direction: 0}, exit: {x: 3, y: 11, direction: 0, level: "level4"}},
      {entrance: {x:  148, y: 7, direction: 0}, exit: {x: 3, y: 11, direction: 0, level: "level4"}}
    ]
  };
  ...
  level4 = { 
    ...
    pipes: [
      ...
      {entrance: {x:  68, y: 7, direction: 0}, exit: {x: 23, y: 1, direction: 1, level: "level4b"}},
      {entrance: {x: 162, y: 7, direction: 0}, exit: {x: 2, y: 1, direction: 1, level: "level5"}},
    ]
  };
  ...
  level4b = { 
    ...
    tileTint: 0,
    pipes: [      
      {entrance: {x:  44, y: 7, direction: 0}, exit: {x: 24, y: 7, direction: 0, level: "level4"}},
    ]
  };
  ...
  level5 = { 
    ...
    tileTint: 1,
    pipes: [
      {entrance: {x: 45, y: 6, direction: 0}, exit: {x: 24, y: 7, direction: 0}},
      {entrance: {x: 96, y: 4, direction: 0}, exit: {x: 3, y: 6, direction: 0, level: "level5b"}},
      {entrance: {x: 138, y: 7, direction: 0}, exit: {x: 3, y: 9, direction: 0, level: "level6"}},
    ]
  };
  ...
  level5b = { 
    ...
    tileTint: 1,
    pipes: [
      {entrance: {x: 47, y: 7, direction: 0}, exit: {x: 24, y: 7, direction: 0, level: "level5"}},
    ]
  };
  ...
  level6 = { 
    ...
    tileTint: 0,
    pipes: [
      {entrance: {x:  85, y: 6, direction: 0}, exit: {x: 7, y: 1, direction: 1, level: "level6b"}},
      {entrance: {x:  111, y: 6, direction: 0}, exit: {x: 7, y: 1, direction: 1, level: "level6b"}},
  ...
  level6b = { 
    ...
    tileTint: 0,
    pipes: [
      {entrance: {x:  105, y: 10, direction: 0}, exit: {x: 121, y: 7, direction: 0, level: "level6"}},
    ]
  };
const AllLevels ={
    level1 : level1,
    ...
    function getId(c, u, l, r, ul, ur, x, y, parseWall, pipeColor, liquidType, tileTint){
     ...
     if (c == "_") return Tile.PiranhaSubmerged;//Red
     if (c == ",") return Tile.LavaFlair;
     if (c == '‡') return Tile.Spiney;
